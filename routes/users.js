   ...
   User.getUserByUsername(username, function(err, user){
   	...
   	User.comparePassword(password, user.password, function(err, isMatch){
   		...
   		if(isMatch){
			 ...
			 if (user.username=="admin") {// all most a complite admin validation
...
/// get to the admin page after authenticate the admin user
  ...
  passport.authenticate('local', {successRedirect:'/users/admin/hompage', failureRedirect:'/admin',failureFlash: true}),
  function(req, res) {
